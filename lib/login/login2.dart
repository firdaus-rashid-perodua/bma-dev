...
class _PeroduaLoginPageState extends State<PeroduaLoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      canPop:
          false, // 🚫 Disallows the system back button or back swipe gesture
      onPopInvokedWithResult: (didPop, result) {
        if (didPop) return;
        // Optional: You can show a SnackBar here if you want to notify the user,
        // e.g., "Press close to exit the app"
      },
      child: Scaffold(
        body: Stack(
          children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            TextField(
                              ...
                              autocorrect:
                                  false, // 🚫 Stops automatic spacing and text replacements
                              enableSuggestions: false,
                              inputFormatters: [
                                FilteringTextInputFormatter.deny(
                                  RegExp(r'\s'),
                                ), // 🚫 Destroys any space appended after a dot
                              ],
